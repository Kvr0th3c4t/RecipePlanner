...
const ShoppingListPDFDocument = ({ categorias = [], userName = "Usuario" }) => {
    ...
    const totalIngredientes = categorias.reduce((total, categoria) =>
        total + categoria.ingredientes.length, 0
    );
            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.content}>
                    {categorias.length === 0 ? (
                        <Text style={styles.emptyMessage}>
                            No hay ingredientes en tu planificación semanal
                        </Text>
                    ) : (
                        <>
                                ...
                                <View key={index} style={styles.categorySection}>
                                    <View style={styles.categoryHeader}>
                                        <Text style={styles.categoryTitle}>
                                            {categoria.categoria_nombre} ({categoria.ingredientes.length})
                                        </Text>
                                    </View>

                                    <View style={styles.ingredientsList}>
                                        {categoria.ingredientes.map((ingrediente, ingredienteIndex) => (
                                            <View key={ingredienteIndex} style={styles.ingredientRow}>
                ...
                <View style={styles.footer}>
                    <Text style={styles.footerText}>
                        Lista de compras generada por recipeplanner.adriancc.com
                    </Text>
                </View>
            </Page>
        </Document>
...
export default ShoppingListPDFDocument;